...
public class Germplasm extends BaseBrapiServerResource
{
	...
	private String                        name;
	private BrapiGermplasm.MatchingMethod matchingMethod;
	...
	{
		List<BrapiGermplasm> result;
		if (name == null || name.equals(""))
			result = germplasmDAO.getAll();
		else
			result = germplasmDAO.getByName(name, matchingMethod);
